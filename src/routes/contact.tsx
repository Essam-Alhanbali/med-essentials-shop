...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with the medical students' club store team." },
    ],
  }),
});
    ...
    <div className="mx-auto max-w-6xl px-6 py-16">
      <div className="grid gap-12 md:grid-cols-2">
        <div>
          ...
          <h1 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">We're here to help.</h1>
          ...
          <h2 className="mt-12 text-sm font-semibold uppercase tracking-wider">FAQ</h2>
